...
"The estimation of the US 2020 election: Donald Trump has a higher chance of winning"
...
model2 <- glm(vote_biden ~ as.factor(gender) + as.factor(race) + as.factor(household_income) + as.factor(education) + as.factor(state) + age, 
...
2. Code and data supporting this analysis is available at：
...
4. (2018b, March 11). Logistic Regression Assumptions and Diagnostics in R. Articles - STHDA. http://www.sthda.com/english/articles/36-classification-methods-essentials/148-logistic-regression-assumptions-and-diagnostics-in-r/

5. Wang, W., Rothschild, D., Goel, S., & Gelman, A. (2015). Forecasting elections with non-representative polls. International Journal of Forecasting, 31(3), 980–991. https://doi.org/10.1016/j.ijforecast.2014.06.001
